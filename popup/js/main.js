...
var DOMManipulator = Vue.component("dom-manipulator", {
    ...
    watch: {
        styles(){
            ...
            chrome.tabs.query({currentWindow: true, active: true}, function (tabs){
                ...
                chrome.tabs.sendMessage(activeTab.id, {"message": $this.selector + " seperator " + JSON.stringify($this.styles)})
            })
        }
    },
    mounted(){
    ...
    template: `
        <div class="input-section">
            <input type="text" placeholder="Enter selector on amy element on your page" v-model="selector">
        ...
        <div>
            ...
            <div class="modal" v-if="showModal">
                <div class="content">
                    ...
                    <p><b>Design Tools</b> contains useful tools that will ease your development. Choose any tool and create an effect you like. Then simply copy pase the generated css codes into your project.</p>
                </div>
            </div>
        </div>
    `
